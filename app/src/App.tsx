      ...
      <div className="min-h-screen bg-clip-dark flex flex-col items-center justify-center gap-10 relative overflow-hidden">
        ...
        >
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 12px rgba(0, 194, 214, 0.6)',
        ...
        <style>{`
          ...
          @keyframes clipai-boot-ring {
            0%   { transform: rotate(0deg); opacity: 0.3; box-shadow: 0 0 12px rgba(0, 194, 214,0.4); }
            50%  { opacity: 0.7; box-shadow: 0 0 24px rgba(0, 194, 214,0.6); }
            100% { transform: rotate(360deg); opacity: 0.3; box-shadow: 0 0 12px rgba(0, 194, 214,0.4); }
          }

      ...
      <div className="min-h-screen bg-clip-dark flex flex-col items-center justify-center gap-10 relative overflow-hidden">
        ...
        >
          <div
            ...
            style={{
              background: 'linear-gradient(90deg, transparent 0%, #07D2DF 50%, transparent 100%)',
              boxShadow: '0 0 12px rgba(7, 210, 223, 0.6)',
        ...
        <style>{`
          ...
          @keyframes clipai-boot-ring {
            0%   { transform: rotate(0deg); opacity: 0.3; box-shadow: 0 0 12px rgba(7, 210, 223,0.4); }
            50%  { opacity: 0.7; box-shadow: 0 0 24px rgba(7, 210, 223,0.6); }
            100% { transform: rotate(360deg); opacity: 0.3; box-shadow: 0 0 12px rgba(7, 210, 223,0.4); }
          }

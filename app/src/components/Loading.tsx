 ...
 *
 * Brand: cyan (#22D3EE) + violet (#8B5CF6) on near-black (#08080A).
 */
        ...
        {particles.map((p) => (
          <div
            ...
            style={{
              ...
              width: `${p.size}px`,
              height: `${p.size}px`,
              background: p.hue === 'cyan' ? '#22D3EE' : '#8B5CF6',
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 24px rgba(34, 211, 238, 0.7), 0 0 48px rgba(34, 211, 238, 0.35)',
            }}
          />
        </div>
      </div>
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'linear-gradient(110deg, transparent 30%, rgba(34, 211, 238, 0.06) 50%, rgba(139,92,246,0.06) 60%, transparent 80%)',
        ...
        >
          <div className="w-20 h-12 rounded-md bg-clip-surface relative overflow-hidden flex-shrink-0">
            <div
              className="absolute inset-0"
              style={{
                background: 'linear-gradient(110deg, transparent 30%, rgba(34, 211, 238, 0.06) 50%, transparent 80%)',
                backgroundSize: '200% 100%',
                animation: 'clipai-shimmer 2.4s ease-in-out infinite',
              }}
            />

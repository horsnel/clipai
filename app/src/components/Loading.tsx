 ...
 *
 * Brand: cyan (#00E5FF) + violet (#8B5CF6) on near-black (#08080A).
 */
        ...
        {particles.map((p) => (
          <div
            ...
            style={{
              ...
              width: `${p.size}px`,
              height: `${p.size}px`,
              background: p.hue === 'cyan' ? '#00E5FF' : '#8B5CF6',
              boxShadow: p.hue === 'cyan'
                ? '0 0 8px rgba(0, 229, 255, 0.8), 0 0 16px rgba(0, 229, 255, 0.4)'
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'linear-gradient(110deg, transparent 30%, rgba(0, 229, 255, 0.06) 50%, rgba(139,92,246,0.06) 60%, transparent 80%)',
        ...
        >
          <div className="w-20 h-12 rounded-md bg-clip-surface relative overflow-hidden flex-shrink-0">
            <div
              className="absolute inset-0"
              style={{
                background: 'linear-gradient(110deg, transparent 30%, rgba(0, 229, 255, 0.06) 50%, transparent 80%)',
                backgroundSize: '200% 100%',
                animation: 'clipai-shimmer 2.4s ease-in-out infinite',
              }}
            />

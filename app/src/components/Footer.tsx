...
export function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="bg-clip-dark border-t border-white/[0.025]">
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-12 lg:py-16">
        ...
        {/* Bottom bar */}
        <div className="mt-12 pt-8 border-t border-white/[0.025] flex flex-col sm:flex-row items-center justify-center gap-4">

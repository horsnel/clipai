      ...
      <div className="flex items-center justify-between mb-5 gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-lg bg-clip-cyan/10 text-clip-cyan border border-clip-cyan hover:bg-clip-cyan hover:text-black transition-colors shadow-[0_0_10px_rgba(34, 240, 255,0.2)]"
          >
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          {audits.length < 8 && (
            <button
              onClick={() => onNavigate('audit')}
              className="card-glass p-5 min-h-[180px] flex flex-col items-center justify-center gap-2 text-center hover:border-clip-cyan hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(34, 240, 255,0.12)] transition-all group"
            >

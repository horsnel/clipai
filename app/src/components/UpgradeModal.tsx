...
export function UpgradeModal({ state, onClose, onNavigate }: UpgradeModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-clip-dark border border-white/[0.08] rounded-t-3xl sm:rounded-3xl w-full sm:max-w-2xl max-h-[92vh] sm:max-h-[88vh] flex flex-col shadow-2xl"
        role="dialog"
        aria-modal="true"
        aria-label="Upgrade your plan"
      >
        {/* Header */}
        <div className="p-5 sm:p-6 border-b border-white/[0.06] flex items-start justify-between gap-3 flex-shrink-0">
            ...
            <button
              ...
              className={`w-full p-4 sm:p-5 rounded-2xl border text-left transition-all flex items-center gap-4 group ${
                plan.popular
                  ...
                  : 'border-white/[0.08] bg-clip-surface/50 hover:bg-clip-surface hover:border-white/[0.15]'
              }`}
            >
              {/* Icon */}
